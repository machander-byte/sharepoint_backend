...
const tourSteps: V2TourStep[] = [
  ...
  },
  {
    ...
    description: "Review target platforms, SharePoint libraries, and destination readiness before planning migration waves."
  },
  {
    title: "Assess",
    targetPage: "assess",
  ...
  },
  {
    title: "Migrate",
    targetPage: "migrate",
    description: "Review migration execution controls, pilot safety limits, and the actions required before any live run."
  },
  {
    title: "Monitor",
    targetPage: "monitor",
